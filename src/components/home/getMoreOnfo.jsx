  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="flex flex-col md:flex-row rounded-[30px] overflow-hidden shadow-lg">
        ...
        >
          {/* Title */}
          <h2 className="font-['Helvetica_Neue'] font-bold text-[24px] sm:text-[32px] md:text-[40px] leading-[1.2] md:leading-[53.23px] tracking-[-1.45px] text-center text-[#0F2137] capitalize max-w-[600px] mb-4 sm:mb-6 md:mb-8 px-2">
            Age 65+ Get Our Complete Service For Free!
          </h2>

          {/* Button with Gradient using Tailwind */}
          <button 
            className="w-full max-w-[268px] h-[46px] sm:h-[56px] rounded-full px-6 sm:px-8 py-3 sm:py-4 text-black font-['Helvetica_Neue'] font-bold text-[12px] sm:text-[14px] leading-[100%] uppercase
